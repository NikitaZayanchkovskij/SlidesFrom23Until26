...
import com.example.designslidefrom23until26.databinding.ItemForTheFirstScreenBinding
import com.example.designslidefrom23until26.users_and_items.User


class FirstAndFifthScreenAdapter:
    ListAdapter<User, FirstAndFifthScreenAdapter.UserHolder>(AllUsersComparator()) {


    class UserHolder(view: View): RecyclerView.ViewHolder(view) {
        val binding = ItemForTheFirstScreenBinding.bind(view)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): UserHolder {
        val view = LayoutInflater
            .from(parent.context)
            .inflate(R.layout.item_for_the_first_screen, parent, false)
